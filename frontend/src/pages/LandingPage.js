    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <div className="inline-block mb-6 px-4 py-2 bg-white text-purple-700 rounded-full text-sm font-medium border border-purple-100">
            Privacy-First Analytics Platform
          </div>
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-slate-900 mb-6 leading-tight">
            Analytics Powered by
            <br />
            <span className="bg-clip-text text-purple-600 font-semibold">Natural Language</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              ...
              size="lg"
              className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-6 text-lg rounded-full shadow-lg hover:shadow-xl"
            >
              Start Tracking Free
            </Button>
            <Button 
      ...
      <section className="py-20 px-6 bg-purple-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Button 
            ...
            onClick={() => navigate('/auth')}
            size="lg"
            className="bg-white text-purple-600 hover:bg-purple-50 px-10 py-6 text-lg rounded-full shadow-xl hover:shadow-2xl font-semibold"
          >
            Start Free Today
          </Button>
        </div>
